...
tf.app.flags.DEFINE_integer("reconstruction_len", 4, "Number of frames to review before anchor points")
tf.app.flags.DEFINE_integer("anchor_len", 4, "Number of frames to between anchor points")
...
tf.app.flags.DEFINE_integer("experiments", 0, "Experiments id.")
    ...
    for _ in xrange(FLAGS.iterations):
      ...
      if current_step % FLAGS.test_every == 0:
        ...
        for action in actions:
          ...
          for ms in range(0, FLAGS.seq_length_out):
